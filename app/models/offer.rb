...
class Offer < ActiveRecord::Base
  ...
  attr_accessible :partner_id, :description, :discount, :price, :time_starts, :time_ends, :daily_cupons,
                  :recurrence, :start_date, :ttype, :partner_pic1_id, :partner_pic2_id, :partner_pic3_id, 
                  :main_pic, :cupon_counter, :temp_distance, :city_id, :original_price, :paused, :deleted, :company_name
